...
export default function HomePage() {
  return (
    <div className="min-h-screen w-screen bg-gradient-to-r from-[##FFEEEE] to-[##DDEFBB]">
      {/* Hero Section */}
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <button className="bg-gradient-to-r from-amber-700 to-amber-800 text-white px-8 py-4 rounded-xl font-semibold text-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300">
              Get Started
            </button>
      ...
      {/* Features Section */}
      <section className="pt-32 pb-20 px-6 z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 ">
            <div className="bg-white/50 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <h3 className="text-2xl font-bold text-amber-900 mb-4">Lightning Fast</h3>
            ...
            <div className="bg-white/50 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <h3 className="text-2xl font-bold text-amber-900 mb-4">Beautiful Design</h3>
            ...
            <div className="bg-white/50 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <h3 className="text-2xl font-bold text-amber-900 mb-4">Easy to Use</h3>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 text-center">
            <div className="bg-white/40 backdrop-blur-sm p-6 rounded-xl">
              <h3 className="text-3xl font-bold text-amber-900 mb-2">10K+</h3>
              <p className="text-amber-800">Happy Developers</p>
            </div>
            <div className="bg-white/40 backdrop-blur-sm p-6 rounded-xl">
              <h3 className="text-3xl font-bold text-amber-900 mb-2">50K+</h3>
              <p className="text-amber-800">Projects Built</p>
            </div>
            <div className="bg-white/40 backdrop-blur-sm p-6 rounded-xl">
              <h3 className="text-3xl font-bold text-amber-900 mb-2">99.9%</h3>
              <p className="text-amber-800">Uptime</p>
            </div>
            <div className="bg-white/40 backdrop-blur-sm p-6 rounded-xl">
              <h3 className="text-3xl font-bold text-amber-900 mb-2">24/7</h3>
